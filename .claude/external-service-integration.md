...
point instead of a literal. There is no Rails initializer / `FootballSupporters.config` here —
...
class MediaClient
  ...
  TRACER    = OpenTelemetry.tracer_provider.tracer("football_supporters")
