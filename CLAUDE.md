...
specific task. This is a **generic template** — replace `FootballSupporters` / `football_supporters` with your real
...
`FootballSupporters` is a Sinatra web application. Replace this section with your own overview: what the
