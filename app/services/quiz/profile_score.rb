...
module Quiz
  ...
  module ProfileScore
    ...
    def call(answers:, weights:, leagues: League.active.ordered.all, locale: Translations::DEFAULT)
      ...
      Result.new(vec:, archetype: Archetype.call(vec, weights:, locale:), leagues: entries)
    end
  end
end
